...
exports.register = async (req, res, next) => {
    ...
    try {
        userService.register(req.body).then(async result => {
            ...
            var secret = result.id + "_" + result.email + "_" + new Date();
            ...
            var mailOptions = {
                ...
                <h2 style="font-size: 24px; margin-bottom: 16px">Chào: <span style="font-weight: 600; color: #09B1BA">${result.user_name}</span> !</h2>
